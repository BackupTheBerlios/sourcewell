...
SourceWell adding features or correcting errors. If one of these is your case, keeping on
reading will be of interest for you.

<P>The documentation that is included in the <A HREF="http://developer.berlios.de/project/filelist.php?group_id=23">SourceWell package</A> has been made with the idea of a developer who wants to
make further development in SourceWell or who wants to make some
modifications so that SourceWell suits his needs.

<P>Note: For developing or modifying SourceWell, <A HREF="http://www.php.net">PHP</A> knowledge is needed. You should also have
certain SQL experience if you want to handle with databases.

<P>Please report to the <A HREF="authors.php">authors</A> any adaptions and/or modifications. This
