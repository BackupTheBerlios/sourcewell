...
echo "<tr><td><center><a href=\"".htmlentities($sess->url("stats.php?option=general"))."\">".$t->translate("General $sys_name Statistics")."</a></center></td>\n";
echo "<td><center><a href=\"".htmlentities($sess->url("stats.php?option=apps"))."\">".$t->translate("Apps by Importance")."</a></center></td></tr>\n";
echo "<tr><td><center><a href=\"".htmlentities($sess->url("stats.php?option=hits"))."\">".$t->translate("Apps by Hits")."</a></center></td>\n";
echo "<td><center><a href=\"".htmlentities($sess->url("stats.php?option=homepage"))."\">".$t->translate("Apps by Homepage Visits")."<tr></a></center></td></tr>\n";
echo "<tr><td><center><a href=\"".htmlentities($sess->url("stats.php?option=download"))."\">".$t->translate("Apps by Downloads")."</a></center></td>\n";
echo "<td><center><a href=\"".htmlentities($sess->url("stats.php?option=rpm"))."\">".$t->translate("Top downloaded RPM Packages")."</a></center></td></tr>\n";
echo "<tr><td><center><a href=\"".htmlentities($sess->url("stats.php?option=deb"))."\">".$t->translate("Top downloaded Debian Packages")."</a></center></td>\n";
echo "<td><center><a href=\"".htmlentities($sess->url("stats.php?option=tgz"))."\">".$t->translate("Top downloaded Slackware Packages")."</a></center></td></tr>\n";
echo "</td></tr>\n";
echo "<tr><td><center><a href=\"".htmlentities($sess->url("stats.php?option=urgency"))."\">".$t->translate("Apps and Downloads by Urgency")."</a></center></td>\n";
echo "<td><center><a href=\"".htmlentities($sess->url("stats.php?option=version_type"))."\">".$t->translate("Apps and Downloads by Version Types")."</a></center></td></tr>\n";
echo "<tr><td><center><a href=\"".htmlentities($sess->url("stats.php?option=sections"))."\">".$t->translate("Apps and Importance by Sections")."</a></center></td>\n";
echo "<td><center><a href=\"".htmlentities($sess->url("stats.php?option=categories"))."\">".$t->translate("Apps by Categories")."</a></center></td></tr>\n";
echo "<tr><td><center><a href=\"".htmlentities($sess->url("stats.php?option=version_number"))."\">".$t->translate("Apps by Version Numbers")."</a></center></td>\n";
echo "<td><center><a href=\"".htmlentities($sess->url("stats.php?option=format"))."\">".$t->translate("Apps and Downloads by Package Formats")."</a></center></td></tr>\n";
echo "<tr><td><center><a href=\"".htmlentities($sess->url("stats.php?option=importance_license"))."\">".$t->translate("Importance by Licenses")."</a></center></td>\n";
echo "<td><center><a href=\"".htmlentities($sess->url("stats.php?option=importance_email"))."\">".$t->translate("Importance by Email Domains")."</a></center></td></tr>\n";
echo "<tr><td><center><a href=\"".htmlentities($sess->url("stats.php?option=email"))."\">".$t->translate("Apps by Email Domains")."</a></center></td>\n";
echo "<td><center><a href=\"".htmlentities($sess->url("stats.php?option=email_section"))."\">".$t->translate("Apps by Sections and Email Domains")."</a></center></td></tr>\n";
echo "<tr><td><center><a href=\"".htmlentities($sess->url("stats.php?option=licenses"))."\">".$t->translate("Apps by Licenses")."</a></center></td>\n";
echo "<td><center><a href=\"".htmlentities($sess->url("stats.php?option=email_license"))."\">".$t->translate("Apps by Licenses and Email Domains")."</a></center></td><tr>\n";
echo "</table>\n";
