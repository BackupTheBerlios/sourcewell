...
?>");
    ...
    if (fopen("include/config.inc", "r") != "false") {
      ...
      print "<center><a href=\"".$sess->url("configure.php3")."\">See Changes</a></center>\n";
    } else {
